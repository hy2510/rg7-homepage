...
const FriendsEntry = ({ imgSrc, title, story }) => {
  return (
    <>
      <div className={style.bridge}></div>
...
const FriendsBottom = ({ imgSrc, currentEarnPoint, goalPoint }) => {
  return (
    <>
      ...
      <div className={style.status}>
        <div className={style.comment}>
          <span className="color-gray-dark">다음 스토리 잠금해제까지</span>
          <span>
...
const LevelMasterProgressBottom = ({ imgSrc, currentEarnPoint, goalPoint }) => {
  return (
    <>
